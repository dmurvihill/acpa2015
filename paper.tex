...
\begin{itemize}
	\item Amazon's EC2 service is very popular and used for by variety of customers, some with sensitive data
	\item This makes VMs on this service a worthwhile target
	...
	\item Alternatively, we could focus on a method which prevents the simple network-based checks used to determine if two instances are co-located.
